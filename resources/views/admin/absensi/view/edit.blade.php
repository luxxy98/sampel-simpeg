<div class="modal fade" id="form_edit_absensi" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="id_sdm" id="edit_id_sdm"
                                    class="form-select form-select-sm" required>
                                {{-- option diisi sama seperti create, atau via AJAX --}}
                            </select>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="total_jam_kerja" id="edit_total_jam_kerja"
                                   step="0.25" min="0" class="form-control form-control-sm">
                        </div>

                        <div class="col-md-4 mb-3">
                            <label class="fs-sm-8 fs-lg-6 fw-bolder mb-1">Total Terlambat (jam)</label>
                            <input type="number" name="total_terlambat" id="edit_total_terlambat"
                                   step="0.25" min="0" class="form-control form-control-sm">
                        </div>

                        <div class="col-md-4 mb-3">
                            <label class="fs-sm-8 fs-lg-6 fw-bolder mb-1">Total Pulang Awal (jam)</label>
                            <input type="number" name="total_pulang_awal" id="edit_total_pulang_awal"
                                   step="0.25" min="0" class="form-control form-control-sm">
                        </div>
                    </div>
                </div>
