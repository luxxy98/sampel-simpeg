<script defer>
    ...
    $('#form_create').on('show.bs.modal', function () {
        ...
        $tbody.find('.detail_mulai, .detail_selesai').flatpickr({ enableTime: true, dateFormat: 'Y-m-d H:i:S' });
        ...
        $('#btn_add_detail_row').off('click').on('click', function () {
            ...
            $tbody.find('tr:last .detail_mulai, tr:last .detail_selesai').flatpickr({ enableTime: true, dateFormat: 'Y-m-d H:i:S' });
        });
