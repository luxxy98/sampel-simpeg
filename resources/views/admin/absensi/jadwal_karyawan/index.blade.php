...
@section('list')
    ...
    <li class="breadcrumb-item text-dark">Jadwal Karyawan</li>
@endsection
            ...
            <div class="card mb-xl-8 mb-5 border-2 shadow">
                <div class="card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder mb-1">Jadwal Karyawan</span>
                        <span class="text-muted fs-7">Penjadwalan shift per pegawai</span>
                    </h3>
