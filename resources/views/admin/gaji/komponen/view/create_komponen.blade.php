                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="text-muted fs-8 mt-1">
                                Mengisi <code>gaji_komponen.id_jabatan</code>. :contentReference[oaicite:4]{index=4}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="text-muted fs-8 mt-1">
                                Mengisi <code>gaji_komponen.id_jenis_komponen</code>. :contentReference[oaicite:5]{index=5}
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="text-muted fs-8 mt-1">
                                Mengisi <code>gaji_komponen.nominal</code> (decimal). :contentReference[oaicite:6]{index=6}
                            </div>
                        </div>
