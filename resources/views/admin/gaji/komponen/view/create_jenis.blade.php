                ...
                <form id="form_create_jenis">
                    <div class="mb-3">
                        ...
                        <div class="text-muted fs-8 mt-1">
                            Mengisi <code>gaji_jenis_komponen.nama_komponen</code>. :contentReference[oaicite:2]{index=2}
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="text-muted fs-8 mt-1">
                            Mengisi <code>gaji_jenis_komponen.jenis</code> (enum). :contentReference[oaicite:3]{index=3}
                        </div>
                    </div>
