...
@section('list')
    ...
    <li class="breadcrumb-item text-dark">Jenis Cuti</li>
@endsection
...
@section('content')
            ...
            <div class="card mb-xl-8 mb-5 border-2 shadow">
                <div class="card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder mb-1">Data Jenis Cuti</span>
                    </h3>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <a type="button" class="btn btn-sm btn-primary fs-sm-8 fs-lg-6"
                               data-bs-toggle="modal" data-bs-target="#form_create" title="Tambah Jenis Cuti">
                                Tambah Jenis Cuti
                            </a>
                        </div>
                    </div>
                ...
                <div class="card-body p-5">
                    <div class="notice d-flex border-primary mb-4 rounded border border-dashed p-4 shadow bg-hover-light-dark">
                        <div class="d-flex flex-stack fs-sm-8 fs-lg-6">
                            <div class="row">
                                <span class="text-gray-700">Berikut ini adalah data master jenis cuti.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive mb-8 shadow p-4 mx-0 border-hover-dark border-primary border-1 border-dashed fs-sm-8 fs-lg-6 rounded-2">
                        <table id="example" class="table table-sm align-middle table-row-bordered table-row-solid gs-0 gy-2">
                            ...
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0 fs-sm-8 fs-lg-6">
                                ...
                                <th class="min-w-250px">Nama Jenis</th>
                                <th class="min-w-150px">Maks/Hari/Tahun</th>
    ...
    @include('admin.cuti.jenis.view.detail')
    @include('admin.cuti.jenis.view.create')
    @include('admin.cuti.jenis.view.edit')
@endsection
...
@section('javascript')
    ...
    @include('admin.cuti.jenis.script.list')
    @include('admin.cuti.jenis.script.create')
    @include('admin.cuti.jenis.script.edit')
    @include('admin.cuti.jenis.script.detail')
    @include('admin.cuti.jenis.script.delete')
@endsection
