                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" id="nama_jenis" class="form-control form-control-sm fs-sm-8 fs-lg-6" maxlength="50" required />
                        ...
                        <div class="col-md-4">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="number" id="maks_hari_per_tahun" class="form-control form-control-sm fs-sm-8 fs-lg-6" min="0" max="366" />
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <select id="status" class="form-select form-select-sm fs-sm-8 fs-lg-6" data-control="select2" data-placeholder="Pilih status" required>
                                    <option></option>
