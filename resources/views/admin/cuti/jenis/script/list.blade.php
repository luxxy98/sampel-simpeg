<script defer>
    function load_data() {
        ...
        const table = $('#example').DataTable({
            ...
            ajax: { url: '{{ route('admin.cuti.jenis.list') }}', cache: false },
            order: [],
            ordering: true,
            columns: [
                ...
                {
                    data: 'maks_hari_per_tahun',
                    name: 'maks_hari_per_tahun',
                ...
                },
                {
                    ...
                    name: 'status',
                    render: function (data) {
                        if (data === 'active') return '<span class="badge badge-success">Aktif</span>';
                        if (data === 'block') return '<span class="badge badge-secondary">Non Aktif</span>';
                        return data ?? '-';
                    }
                },
            ]
