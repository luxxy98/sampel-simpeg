...
@section('list')
    ...
    <li class="breadcrumb-item text-dark">Pengajuan Cuti</li>
@endsection
...
@section('content')
            ...
            <div class="card mb-xl-8 mb-5 border-2 shadow">
                <div class="card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder mb-1">Data Pengajuan Cuti</span>
                    </h3>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end">
                            <a type="button" class="btn btn-sm btn-primary fs-sm-8 fs-lg-6"
                               data-bs-toggle="modal" data-bs-target="#form_create" title="Tambah Pengajuan Cuti">
                                Tambah Pengajuan
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="d-flex flex-stack fs-sm-8 fs-lg-6 w-100">
                            <div class="row w-100 g-2">
                                <div class="col-md-3">
                                    ...
                                    <input type="date" id="filter_tanggal_mulai" class="form-control form-control-sm fs-sm-8 fs-lg-6" />
                                </div>
                                <div class="col-md-3">
                                    <label class="fw-bolder mb-1">Tanggal Selesai (<=)</label>
                                    <input type="date" id="filter_tanggal_selesai" class="form-control form-control-sm fs-sm-8 fs-lg-6" />
                                </div>
                                <div class="col-md-3">
                    ...
                    <div class="table-responsive mb-8 shadow p-4 mx-0 border-hover-dark border-primary border-1 border-dashed fs-sm-8 fs-lg-6 rounded-2">
                        <table id="example" class="table table-sm align-middle table-row-bordered table-row-solid gs-0 gy-2">
                            ...
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0 fs-sm-8 fs-lg-6">
                                <th class="min-w-90px ps-5">Aksi</th>
                                <th class="min-w-220px">Nama</th>
                                <th class="min-w-160px">Jenis</th>
                                <th class="min-w-120px">Mulai</th>
                                <th class="min-w-120px">Selesai</th>
                                <th class="min-w-90px">Hari</th>
                                <th class="min-w-120px">Status</th>
                                <th class="min-w-140px">Tgl Pengajuan</th>
                            </tr>
                            </thead>
    ...
    @include('admin.cuti.pengajuan.view.detail')
    @include('admin.cuti.pengajuan.view.create')
    @include('admin.cuti.pengajuan.view.edit')
    @include('admin.cuti.pengajuan.view.approve')
@endsection
...
@section('javascript')
    ...
    @include('admin.cuti.pengajuan.script.list')
    @include('admin.cuti.pengajuan.script.create')
    @include('admin.cuti.pengajuan.script.edit')
    @include('admin.cuti.pengajuan.script.detail')
    @include('admin.cuti.pengajuan.script.approve')
    @include('admin.cuti.pengajuan.script.delete')
@endsection
