                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <select id="id_jenis_cuti" class="form-select form-select-sm fs-sm-8 fs-lg-6" data-control="select2" data-placeholder="Pilih jenis cuti" required>
                                    <option></option>
                        ...
                        <div class="col-md-4">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="date" id="tanggal_mulai" class="form-control form-control-sm fs-sm-8 fs-lg-6" required />
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="date" id="tanggal_selesai" class="form-control form-control-sm fs-sm-8 fs-lg-6" required />
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <textarea id="alasan" rows="2" class="form-control form-control-sm fs-sm-8 fs-lg-6" maxlength="255" required></textarea>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="alert alert-secondary py-2 mb-0 fs-sm-8 fs-lg-6">
                                <strong>Catatan:</strong> jumlah hari dihitung otomatis (selisih tanggal + 1).
                            </div>
                        </div>
                    </div>
                </div>
