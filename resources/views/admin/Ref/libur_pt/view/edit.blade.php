        ...
        <form method="post" id="bt_submit_edit">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Libur PT</h5>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" id="edit_tanggal" class="form-control form-control-sm fs-sm-8 fs-lg-6" required />
                        ...
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <textarea id="edit_keterangan" class="form-control form-control-sm fs-sm-8 fs-lg-6" rows="3" required></textarea>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
