    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Detail Libur PT</h5>
                ...
                <div id="show_data">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div id="detail_tanggal" class="text-gray-700"></div>
                        </div>
                        <div class="col-md-12 mb-3">
                            <div class="fw-bolder">Keterangan</div>
                            <div id="detail_keterangan" class="text-gray-700"></div>
                        </div>
                    </div>
                </div>
            </div>
