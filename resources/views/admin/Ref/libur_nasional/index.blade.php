...
@section('content')
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <a type="button" class="btn btn-sm btn-primary fs-sm-8 fs-lg-6"
                               data-bs-toggle="modal" data-bs-target="#form_create" title="Tambah Libur Nasional">
    ...
    @include('admin.ref.libur_nasional.view.detail')
    @include('admin.ref.libur_nasional.view.create')
    @include('admin.ref.libur_nasional.view.edit')
@endsection
...
@section('javascript')
    ...
    @include('admin.ref.libur_nasional.script.list')
    @include('admin.ref.libur_nasional.script.create')
    @include('admin.ref.libur_nasional.script.edit')
    @include('admin.ref.libur_nasional.script.detail')
    @include('admin.ref.libur_nasional.script.delete')
@endsection
