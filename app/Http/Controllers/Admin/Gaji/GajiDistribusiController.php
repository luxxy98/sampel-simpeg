...
final class GajiDistribusiController extends Controller
{
    ...
    public function index(): View
    {
        return view('admin.gaji.distribusi.index', [
            'periodeOptions' => $this->service->periodeOptions(),
            'sdmOptions' => $this->service->sdmOptions(),
            'rekeningOptions' => $this->service->rekeningOptions(),
            'trxOptions' => $this->service->trxOptions(),
        ]);
    }
