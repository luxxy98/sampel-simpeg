...
final class GajiKomponenService
{
    ...
    {
        $q = DB::table('gaji_komponen as gk')
            ->leftJoin('master_jabatan as mj', 'mj.id_jabatan', '=', 'gk.id_jabatan')
    ...
    {
        return DB::table('gaji_komponen as gk')
            ->leftJoin('master_jabatan as mj', 'mj.id_jabatan', '=', 'gk.id_jabatan')
            ->leftJoin('gaji_jenis_komponen as gjk', 'gjk.id_jenis_komponen', '=', 'gk.id_jenis_komponen')
            ->select([
                'gk.*',
    ...
    {
        return DB::table('gaji_jenis_komponen')
